...
export type Assignment = { id:number; distribution_version_id:number; rotation_block_id:number|null; training_site_id:number|null; student_subgroup_id:number|null; student:Student; student_subgroup?:{name:string;group?:{name:string}}|null; rotation_block?:{block_code:string;from_week?:number|null;to_week?:number|null;rotation?:{name?:string;start_date?:string|null;course?:{name_ar?:string;name_en?:string};academic_year?:{code:string}}}|null; training_site?:{name_ar:string;name_en?:string|null}|null; department?:{name_ar:string;name_en?:string|null}|null };
