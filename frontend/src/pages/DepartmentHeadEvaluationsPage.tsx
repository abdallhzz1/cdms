...
const statusLabel: Record<string, { ar: string; en: string }> = { draft: { ar: 'مسودة', en: 'Draft' }, submitted: { ar: 'بانتظار الاعتماد', en: 'Awaiting approval' }, approved: { ar: 'معتمد', en: 'Approved' } };
...
export function DepartmentHeadEvaluationsPage() {
  ...
  const canApprove = can('department_head_evaluations.approve') || can('approvals.decide');
