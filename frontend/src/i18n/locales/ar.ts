...
const ar: typeof en = {
  ...
  permissions: {
    ...
    approval_workflows_view: { description: 'عرض إعداد مسارات الاعتماد' },
    approval_workflows_manage: { description: 'تعديل مسارات الاعتماد' },
    approvals_view: { description: 'عرض مركز الاعتمادات' },
    approvals_decide: { description: 'اتخاذ قرار الاعتماد' },
