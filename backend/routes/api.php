...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('group-registration-cycles')->group(function () {
            ...
            Route::delete('/{cycle}', [\App\Http\Controllers\Api\V1\GroupRegistrationAdminController::class, 'destroy'])->middleware('permission:group_registration.manage_groups');
        ...
        Route::get('dashboard/overview', [\App\Http\Controllers\Api\V1\DashboardOverviewController::class, 'show'])->middleware('throttle:operational-read');
