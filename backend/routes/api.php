...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('correspondence/{correspondence}/mailbox/{action}', [CorrespondenceController::class, 'setMailboxState'])->middleware('permission:correspondence.view');
        ...
        Route::get('quality-operations', [QualityOperationsController::class, 'index'])->middleware('permission:quality.view');
        Route::post('quality-findings', [QualityOperationsController::class, 'storeFinding'])->middleware('permission:quality.manage');
        Route::put('quality-findings/{finding}', [QualityOperationsController::class, 'updateFinding'])->middleware('permission:quality.manage');
        Route::post('quality-evidence', [QualityOperationsController::class, 'storeEvidence'])->middleware('permission:quality.manage');
        Route::put('quality-evidence/{evidence}', [QualityOperationsController::class, 'updateEvidence'])->middleware('permission:quality.manage');
