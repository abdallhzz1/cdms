...
class OperationalTask extends Model
{
    ...
    protected $casts = [
        'created_by' => 'integer', 'assigned_to' => 'integer', 'source_id' => 'integer',
        'due_date'=>'date','started_at'=>'datetime','completed_at'=>'datetime',
    ];
    ...
    public function attachments() { return $this->hasMany(OperationalTaskAttachment::class); }
}
