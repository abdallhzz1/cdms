...
return [
    ...
    'backup' => [
         ...
         *
         * Phase 6E MEDIUM-04 remediation: enabled to ensure backup archive integrity
         * is verified after every backup run. This adds a small post-backup overhead
         * (reading the ZIP index) but ensures corrupt archives are detected immediately
         * and trigger the BackupHasFailed alert email rather than being discovered only
         * at restore time.
         *
         * Accepted trade-off: negligible extra time for a DB-only backup of this size.
         */
        'verify_backup' => true,
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_ALERT_EMAIL', 'noreply@cdms.local'),
